...
\noindent \textbf{Bài tập nhỏ:} Hãy thay thế phần chú thích trong đoạn mã sau bằng một vòng lặp \texttt{while}.
...
\noindent \textbf{Bài tập nhỏ:} Viết một chương trình yêu cầu người dùng nhập vào 10 số nguyên, sau đó in ra số lẻ lớn nhất trong số các số đã nhập. Nếu không có số lẻ nào được nhập, chương trình nên in ra một thông báo tương ứng.
